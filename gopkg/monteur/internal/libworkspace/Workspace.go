...
func (me *Workspace) processDataByJob() {
	...
	case libmonteur.JOB_SETUP:
		me.ConfigDir = me.Filesystem.SetupConfigDir
		me.JobTOMLFile = me.Filesystem.SetupTOMLFile
		...
		(*me.Variables)[libmonteur.VAR_TMP] = me.Filesystem.SetupTMPDir
	...
	case libmonteur.JOB_PREPARE:
		me.ConfigDir = me.Filesystem.PrepareConfigDir
		me.JobTOMLFile = me.Filesystem.PrepareTOMLFile
		me.Filesystem.WorkspaceLogDir = filepath.Join(
			me.Filesystem.LogDir,
		...
		// assign specific variables
		(*me.Variables)[libmonteur.VAR_TMP] = me.Filesystem.PrepareTMPDir
	...
	case libmonteur.JOB_RELEASE:
		me.ConfigDir = me.Filesystem.ReleaseConfigDir
		me.JobTOMLFile = me.Filesystem.ReleaseTOMLFile
		me.Filesystem.WorkspaceLogDir = filepath.Join(
			me.Filesystem.LogDir,
		...
		// assign specific variables
		(*me.Variables)[libmonteur.VAR_TMP] = me.Filesystem.ReleaseTMPDir
		(*me.Variables)[libmonteur.VAR_PACKAGE] = me.Filesystem.PackageTMPDir
