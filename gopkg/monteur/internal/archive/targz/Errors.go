...
const (
	...
	ERROR_FILE_CHMOD_FAILED        = "failed to chmod file"
	ERROR_FILE_CHTIMES_FAILED      = "failed to chtimes file"
	...
	ERROR_PATH_REL_FAILED  = "failed to relative pathing"

	ERROR_SYMLINK_CREATE_FAILED = "failed to create symlink"
	ERROR_SYMLINK_READ_FAILED   = "failed to read symlink"
	ERROR_SYMLINK_OUT_OF_BOUND  = "symlink is targeting outside Raw directory"
	ERROR_SYMLINK_UNRESOLVED    = "symlink is not resolvable"
)
